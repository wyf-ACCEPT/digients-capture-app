...
|---------------|------------|------------------|-------|
| **0.2.2 (1)** | 2026-05-14 | AWS Lambda       | Backend cutover to `api.digients.tech` (AWS Lambda + Aurora). Old builds keep defaulting to CF Workers via `String.fromEnvironment` fallback; this build is the first to point at AWS. No user-facing behavior change. |
